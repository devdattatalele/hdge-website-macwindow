      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          <div className="col-span-1">
            ...
            <p className="text-gray-400 mb-4">
              Intelligent AI that understands your business, tracks data, and delivers personalized support, 24/7.
            </p>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="#" className="text-gray-400 hover:text-white transition-colors">AI Roadmap</Link>
              </li>
            </ul>
          </div>
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="#" className="text-gray-400 hover:text-white transition-colors">Guides</Link>
              </li>
              <li>
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between">
          <p className="text-gray-500 text-sm mb-4 md:mb-0">
            © 2025 HDGE3 LABS. All rights reserved.
          </p>
